...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        banner: '/*@preserve\n' +
            ' * Tempus Dominus DateTime Picker v<%= pkg.version %> (<%= pkg.homepage %>)\n' +
        ...
        sass: {
            production: {
                ...
                files: {
                    'dist/css/<%= pkg.name %>.min.css': 'src/sass/<%= pkg.name %>.scss'
                }
            },
            development: {
                options: {
    ...
    grunt.registerTask('copy', 'Generate docs', function () {
        grunt.file.copy('dist/js/tempusdominus-datetimepicker.js', 'src/docs/theme/js/tempusdominus-datetimepicker.js');
        grunt.file.copy('dist/css/tempusdominus-datetimepicker.css', 'src/docs/theme/css/tempusdominus-datetimepicker.css');
    });
